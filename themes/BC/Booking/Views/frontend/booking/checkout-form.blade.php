<div class="form-checkout" id="form-checkout">
    ...
    <div class="form-section">
        <div class="row">
            ...
            {{--                <div class="form-group"> --}}
            {{--                    <label >{{__("ZIP code/Postal code")}} aaaaaaaaaaaaaaaaaa</label> --}}
            ...
            <div class="col-md-6 field-country d-none">
                <div class="form-group">
                    ...
                    <select name="country" class="form-control">
                        {{--                        <option value="يييي">{{__('-- Select --')}}</option> --}}
    ...
    <div class="form-group">
        <label class="term-conditions-checkbox">
            <input type="checkbox" checked name="term_conditions"> {{ __('I have read and accept the') }} <a

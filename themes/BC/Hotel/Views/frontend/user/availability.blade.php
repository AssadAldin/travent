...
@section('content')
    ...
    <div class="language-navigation mt-3">
        <div class="panel-body">
            <div class="filter-div d-flex justify-content-between ">
                <div class="row">
                    <form method="get" action="" class="d-flex col-12" role="search">
    ...
    @if (count($rows))
        <div class="panel">
            ...
            <div class="panel-title"><strong><span class="p-1 bg-primary text-white">{{ __('Day Stay') }}</span> - <span
                ...
                {{-- <a href="{{ route('show.avail.hotel', ['hotel_id' => $hotel->id]) }}"
                        ...
                        <form class="row form_modal_calendar form-horizontal" novalidate onsubmit="return false">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class=""><small>{{ __('Here you can add any note to this day') }}</small>
                                    </div>

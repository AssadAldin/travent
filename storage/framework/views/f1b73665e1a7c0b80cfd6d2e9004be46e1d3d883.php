<form class="form bravo-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    ...
    <div class="form-group">
        <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="form-control" name="email" autocomplete="off" placeholder="<?php echo e(__('Email address')); ?>">
...
<?php /**PATH /home/leo/Projects/Laravel/travent1/modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>
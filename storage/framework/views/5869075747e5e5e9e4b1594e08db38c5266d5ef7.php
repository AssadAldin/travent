...
$menus = [
    ...
    'mobile' => [
        'position' => 51,
        'url' => route('mobile.navbar'),
        'title' => __('Mobile'),
        'icon' => 'icon ion-ios-tablet-portrait icon',
        'permission' => 'setting_update',
    ],
    'tools' => [
        'position' => 90,
        ...
        <li class="<?php echo e($menuItem['class']); ?>"><a href="<?php echo e(url($menuItem['url'])); ?>">
            ...
            <?php if(!empty($menuItem['children'])): ?>
                ...
                <ul class="children">
                    ...
                    <li class="">
                        <a href="<?php echo e(route('whatsapp.config')); ?>">
...
<?php /**PATH /home/leo/Projects/Laravel/travent1/modules/Layout/admin/parts/sidebar.blade.php ENDPATH**/ ?>
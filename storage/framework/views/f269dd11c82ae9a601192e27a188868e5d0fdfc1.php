...
<body
    class="<?php echo e($enable_multi_lang ?? '' ? 'enable_multi_lang' : ''); ?> <?php if(setting_item('site_enable_multi_lang')): ?> site_enable_multi_lang <?php endif; ?>" style="font-family: 'Cairo', sans-serif;">
    <div id="app">
                    ...
                    <div class="row">
                        <div class="col-md-6 copy-right">
                            <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Booking Core by')); ?> <a
                                href="<?php echo e(__('https://www.bookingcore.org')); ?>"
                                target="_blank"><?php echo e(__('BookingCore Team')); ?></a>
                        </div>
                        <div class="col-md-6">
                            <div class="text-md-right footer-links d-none d-sm-block">
                                <a href="<?php echo e(__('https://www.bookingcore.org')); ?>"
                                    target="_blank"><?php echo e(__('About Us')); ?></a>
                                <a href="<?php echo e(__('https://m.me/bookingcore')); ?>"
                                    target="_blank"><?php echo e(__('Contact Us')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script
        src="<?php echo e(asset('themes/admin/libs/bootstrap-4.6.2-dist/js/bootstrap.bundle.min.js?_ver=' . config('app.asset_version'))); ?>">
    </script>
...
<?php /**PATH /home/leo/Projects/Laravel/travent1/modules/Layout/admin/app.blade.php ENDPATH**/ ?>
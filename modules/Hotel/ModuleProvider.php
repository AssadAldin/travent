        ...
        return [
            'hotel' => [
                ...
                'children' => [
                    ...
                    'Availability' => [
                        'url' => route('hotel.admin.all.availability'),
                        'title' => __('All Hotels Availability'),
                        'permission' => 'hotel_view',
                    ],
                    'attribute' => [
                    ...
                    'hotels report' => [
                        'url' => route('hotel.report.admin'),
                        'title' => __('Hotels Report'),
                        'permission' => 'hotel_view',
                    ],
                ]
            ],
        ...
        if (Hotel::isEnable()) {
            $res['hotel'] = [
                ...
                'children' => [
                    ...
                    'Availability' => [
                        'url' => route('hotel.admin.all.availability.user'),
                        'title' => __('All Hotels Availability'),
                        'permission' => 'hotel_view',
                    ],
                    [

@if (is_default_lang())
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-group d-none">
                ...
                <br>
                <label>
                    <input type="checkbox" name="allow_full_day" @if ($row->allow_full_day) checked @endif
                        value="1"> {{ __('Enable full day booking') }}
                </label>
                <div class="small">
            ...
            <label class="font-weight-bold">{{ __('Full Day') }}</label>
            <div class="row">
                <div class="col-md-6">
            ...
            <label class="font-weight-bold">{{ __('Day Stay') }}</label>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{ __('Time for check in') }}</label>
                        <input type="text" value="{{ $row->check_in2 }}" placeholder="{{ __('Eg: 12:00AM') }}"
                            name="check_in2" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>{{ __('Time for check out') }}</label>
                        <input type="text" value="{{ $row->check_out2 }}" placeholder="{{ __('Eg: 11:00AM') }}"
                            name="check_out2" class="form-control">
                    </div>
                </div>
            </div>
            @if (is_default_lang())
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            @endif
            <hr>
            <h3 class="panel-body-title app_get_locale">{{ __('Weekends') }}</h3>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label><input type="checkbox" name="full_weekend"
                                @if ($row->full_weekend) checked @endif value="1">
                            {{ __('Minimum book all weekends days') }}
                        </label>
                    </div>
                </div>
            </div>
            @if (\Auth::user()->role_id == 5 or \Auth::user()->role_id == 1)
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>{{ __('Select weekends days') }} </label>
                            <label><input type="checkbox" name="su"
                                    @if (str_contains($row->weekends_days, 0)) checked @endif value="0">
                                {{ __('Sunday') }}
                            </label>
                            <label><input type="checkbox" name="mo"
                                    @if (str_contains($row->weekends_days, 1)) checked @endif value="1">
                                {{ __('Monday') }}
                            </label>
                            <label><input type="checkbox" name="tu"
                                    @if (str_contains($row->weekends_days, 2)) checked @endif value="2">
                                {{ __('Tuesday') }}
                            </label>
                            <label><input type="checkbox" name="we"
                                    @if (str_contains($row->weekends_days, 3)) checked @endif value="3">
                                {{ __('Wednesday') }}
                            </label>
                            <label><input type="checkbox" name="th"
                                    @if (str_contains($row->weekends_days, 4)) checked @endif value="4">
                                {{ __('Thursday') }}
                            </label>
                            <label><input type="checkbox" name="fr"
                                    @if (str_contains($row->weekends_days, 5)) checked @endif value="5">
                                {{ __('Friday') }}
                            </label>
                            <label><input type="checkbox" name="sa"
                                    @if (str_contains($row->weekends_days, 6)) checked @endif value="6">
                                {{ __('Saturday') }}
                            </label>
                        </div>
                    </div>
            ...
            @if (\Auth::user()->role_id == 5 or \Auth::user()->role_id == 1)
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="panel-body-title app_get_locale">{{ __('Discount') }}</h3>
                        <div class="form-group">
                            <label>{{__('Discount Code')}}</label>
                            <input type="text" class="form-control" name="discount_code" value="{{$row->discount_code}}" />
                        </div>
                        <div class="form-group">
                            <label>{{__('Discount percent')}}</label>
                            <input type="text" class="form-control" name="discount_percent1" value="{{$row->discount_percent1}}" />
                        </div>
                    </div>
                </div>
            @endif

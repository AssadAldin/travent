                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="100px"> {{ __('Day Stay') }}</th>
                                            <th width="100px"> {{ __('Full Day') }}</th>
                                        ...
                                        @if ($rows->total() > 0)
                                            @foreach ($rows as $row)
                                                ...
                                                <tr class="{{ $row->status }}">
                                                    ...
                                                    <td class="title">
                                                        <a
                                                            href="{{ route('hotel.admin.room.edit', ['hotel_id' => $hotel->id, 'id' => $row->id]) }}">{{ $translation->title }}</a>
                                                    </td>
                                                    <td>{{ $row->number }}</td>
                                                    @if ($row->day_stay)

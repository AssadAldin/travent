...
//Assad
Route::put('/update/room/type/{room}','RoomController@updateType1')->name('room.update.type')->middleware('auth');

// Sort Image Assadaldin
Route::get('/images/sort/{hotel}','HotelController@sortImage')->name('sort.image.index');
Route::put('/images/sort/{id}','HotelController@saveSort')->name('sort.image.update');
// end sort
Route::get('/','HotelController@index')->name('hotel.admin.index');
Route::get('/all/hotel/availability','HotelController@all_availability')->name('hotel.admin.all.availability');
...
//All hotels availability
Route::get('/loadDates/all','AvailabilityController@loadDatesAll')->name('hotel.admin.room.availability.loadDates.all');

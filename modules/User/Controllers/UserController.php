...
class UserController extends FrontendController
{
    ...
    {
        return view('User::frontend.appointment');
    }
    ...
    public function profileUpdate(Request $request)
    {
        ...
        $user->user_notifi_lang = $request->input('user_notifi_lang');
    ...
    public function verify(User $user, Request $request)
    {
        if (! $request->hasValidSignature()) {
            $message = "We are sorry... This link has expired";
            return view('User::frontend.verify-user')->with('message', $message);
        }else{

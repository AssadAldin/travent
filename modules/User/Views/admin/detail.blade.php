                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ __('Phone For Travent')}}</label>
                                        <input type="text" value="{{old('phone',$row->phone)}}" placeholder="{{ __('Phone For Travent')}}" name="phone" class="form-control" required   >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ __('Phone For Guest')}}</label>
                                        <input type="text" value="@if($row->phone2){{$row->phone2}}@else{{$row->phone}}@endif" placeholder="{{ __('Phone For Guest')}}" name="phone2" class="form-control"  >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ __('Phone For whatsapp')}}</label>
                                        <input type="text" value="@if($row->phone3) {{$row->phone3}}@else{{$row->phone}}@endif" placeholder="{{ __('Phone For whatsapp')}}" name="phone3" class="form-control"   >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">

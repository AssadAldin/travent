...
// Host create payout
Route::get('/createPayout/{id}','UserController@createPayout')->name("createPayout");
Route::post('/storePayout/{id}','UserController@storePayout')->name("storePayout");
Route::get('/venderPayout/create','UserController@venderPayout')->name("venderPayout");
// end payout
// Host Bank account
Route::get("/user/create/bank/{id}","UserController@createBankAccount")->name("createHostBankAccount");
Route::post("/user/meta/bank/{id}","PayoutController@storeAdminPayoutAccounts")->name("user.bank.account");

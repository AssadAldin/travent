...
Route::group(['prefix' => 'booking'],function (){
    ...
    Route::get('/index2','BookingController@index2')->name('report.admin.booking2');
    Route::get('/booking_not_completed','BookingController@booking_not_completed')->name('report.admin.booking_not_completed');
    ...
    Route::get('/hotels/report','HotelController@index')->name('hotel.report.admin');
});

...
<body class="user-page container-fluid {{$body_class ?? ''}} @if(setting_item_with_lang('enable_rtl')) is-rtl @endif" style="font-family: 'Cairo', sans-serif;">
    @if(!is_demo_mode())
    ...
    <div class="bravo_wrap">
        ...
        <div class="bravo_user_profile" style="margin:0%;padding:0%;">
        ...
        @if (!$w2n)
            <nav class="navbar fixed-bottom navbar-light bg-light align-items-end d-md-none d-lg-none py-0">
                @if (!empty($items))

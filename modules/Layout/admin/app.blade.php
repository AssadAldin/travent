...
<body
    class="{{ $enable_multi_lang ?? '' ? 'enable_multi_lang' : '' }} @if (setting_item('site_enable_multi_lang')) site_enable_multi_lang @endif" style="font-family: 'Cairo', sans-serif;">
    <div id="app">
                    ...
                    <div class="row">
                        <div class="col-md-6 copy-right">
                            {{ date('Y') }} &copy; {{ __('Booking Core by') }} <a
                                href="{{ __('https://www.bookingcore.org') }}"
                                target="_blank">{{ __('BookingCore Team') }}</a>
                        </div>
                        <div class="col-md-6">
                            <div class="text-md-right footer-links d-none d-sm-block">
                                <a href="{{ __('https://www.bookingcore.org') }}"
                                    target="_blank">{{ __('About Us') }}</a>
                                <a href="{{ __('https://m.me/bookingcore') }}"
